...
df1 <- df1 %>% within(state <- relevel(state, ref = "CA"))
...
#       ){
#           mod_df <- df1 %>%
#             mutate(y = ifelse(parttimeworkerhr == "For economic reasons",1,0)) %>%
#             filter(civilian == "civilian", age16up == 1, year == yr,
#                    laborforce=="In the laborforce",
#                    employed == "Employed",
#                    employed2=="Part-time workers") %>%
#             select(y, id, contains("pwsswgt"), year, month, state, sex, race, hisp, married, 
#                    educ, disability, hearing, seeing, remembering, mobility, 
#                    selfcare, erranddifficulty, age1664, age25up, prtage)
#         
#         inter <- ""
...
#           mod_df <- mod_df %>% select(-age25up)
#         }
#         mod_df$prtage <- mod_df$prtage %>% scale() %>% as.numeric()
#         mod_df$prtage2 <-  mod_df$prtage^2
#         mod_df$prtage3 <-  mod_df$prtage^3
...
#           mod_logit[[i]]  <- svyglm(y~month+prtage+prtage2+prtage3+1,
...
#         }
#         if (!all(filterer[i,] == "All")){
#           mod_logit[[i]]  <- svyglm(paste("y~month+prtage+prtage2+prtage3+",paste(variables,collapse = "+"),"+",inter,"+1",sep=""),
#                               family = quasibinomial,
#                               design = mod_design,
#                               rescale = TRUE)
#           mod_summary <- mod_logit[[i]]%>% summary()
...
#         
#         cloud_prep()
#         saveRDS(mod_logit[[i]], paste("gen",YEAR,"_analysis",yr,"_",i,"empptecon_models.rds",sep=""))
#         saveRDS(mod_summary, paste("gen",YEAR,"_analysis",yr,"_",i,"empptecon_models_summary.rds",sep=""))
#         
#         send_object(paste("gen",YEAR,"_analysis",yr,"_",i,"empptecon_models.rds",sep=""),
#                     "demographics_project_models",
#                     paste("gen",YEAR,"_analysis",yr,"_",i,"empptecon_models.rds",sep=""))
#         send_object(paste("gen",YEAR,"_analysis",yr,"_",i,"empptecon_models_summary.rds",sep=""),
#                     "demographics_project_models",
#                     paste("gen",YEAR,"_analysis",yr,"_",i,"empptecon_models_summary.rds",sep=""))
#       }
#       
#       mod_logit[[i]] <- NA   
#      }
...
i = 1534
   ...
   if(filterer[i,"state"] == "Any" &
      ...
      mod_wint%>% predict(newdata = data.frame(month = 1 %>% as.factor(), state = "NH", race = "White", hisp ="Non-Hispanic nor Latino ethnicity", educ = "High school graduates, no college", prtage = 0.0 , prtage2 = 0.0, prtage3 = 0.0 , sex = "Women", married = "Not married", disability = "No Disability"), type = "response")
```
   ...
   if(filterer[i,"state"] == "Any" &
      ...
      (filterer[i,"disability"] == "Any" |
       ...
       filterer[i,"erranddifficulty"] == "Any") 
        ...
        if (!all(filterer[i,] == "All")){
          mod_logit[[i]]  <- svyglm(paste("y~month+prtage+prtage2+prtage3+",paste(variables,collapse = "+"),"+1",sep=""),
                              family = quasibinomial,
                              design = mod_design,
                              rescale = TRUE)
          mod_summary <- mod_logit[[i]]%>% summary()
...
saveRDS(mod_anova_dis_chi,paste("gen",YEAR,"_analysis",yr,"_",i,"empptecon_models_anova_chi_dis.rds",sep=""))
saveRDS(mod_anova_int_chi,paste("gen",YEAR,"_analysis",yr,"_",i,"empptecon_models_anova_chi_int.rds",sep=""))
send_object( paste("gen",YEAR,"_analysis",yr,"_",i,"empptecon_models_anova_chi_dis.rds",sep=""),"demographics_project_models",paste("gen",YEAR,"_analysis",yr,"_",i,"empptecon_models_anova_chi_dis.rds",sep=""))
send_object( paste("gen",YEAR,"_analysis",yr,"_",i,"empptecon_models_anova_chi_int.rds",sep=""),"demographics_project_models",paste("gen",YEAR,"_analysis",yr,"_",i,"empptecon_models_anova_chi_int.rds",sep=""))

unlink(paste("gen",YEAR,"_analysis",yr,"_",i,"empptecon_models_anova_chi_dis.rds",sep=""))
unlink(paste("gen",YEAR,"_analysis",yr,"_",i,"empptecon_models_anova_chi_int.rds",sep=""))
```
...
saveRDS(mod_anova_dis,paste("gen",YEAR,"_analysis",yr,"_",i,"empptecon_models_anova_dis.rds",sep=""))
saveRDS(mod_anova_int,paste("gen",YEAR,"_analysis",yr,"_",i,"empptecon_models_anova_int.rds",sep=""))
send_object( paste("gen",YEAR,"_analysis",yr,"_",i,"empptecon_models_anova_dis.rds",sep=""),"demographics_project_models",paste("gen",YEAR,"_analysis",yr,"_",i,"empptecon_models_anova_dis.rds",sep=""))
send_object( paste("gen",YEAR,"_analysis",yr,"_",i,"empptecon_models_anova_int.rds",sep=""),"demographics_project_models",paste("gen",YEAR,"_analysis",yr,"_",i,"empptecon_models_anova_int.rds",sep=""))

unlink(paste("gen",YEAR,"_analysis",yr,"_",i,"empptecon_models_anova_dis.rds",sep=""))
unlink(paste("gen",YEAR,"_analysis",yr,"_",i,"empptecon_models_anova_int.rds",sep=""))
```
...
mod_wodis_summary <- mod_wodis %>% summary()
        ...
        saveRDS(mod_wodis, paste("gen",YEAR,"_analysis",yr,"_",i,"empptecon_models_wodis.rds",sep=""))
        saveRDS(mod_wodis_summary,
                paste("gen",YEAR,"_analysis",yr,"_",i,"empptecon_models_wodis_summary.rds",sep=""))
        
        send_object(paste("gen",YEAR,"_analysis",yr,"_",i,"empptecon_models_wodis.rds",sep=""),
                    "demographics_project_models",
                    paste("gen",YEAR,"_analysis",yr,"_",i,"empptecon_models_wodis.rds",sep=""))
        send_object(paste("gen",YEAR,"_analysis",yr,"_",i,"empptecon_models_wodis_summary.rds",sep=""),
                    "demographics_project_models",
                    paste("gen",YEAR,"_analysis",yr,"_",i,"empptecon_models_wodis_summary.rds",sep=""))
         unlink(paste("gen",YEAR,"_analysis",yr,"_",i,"empptecon_models_wodis.rds",sep=""))
         unlink(paste("gen",YEAR,"_analysis",yr,"_",i,"empptecon_models_wodis_summary.rds",sep=""))
```
...
mod_wint_summary <- mod_wint %>% summary()
        ...
        saveRDS(mod_wint, paste("gen",YEAR,"_analysis",yr,"_",i,"empptecon_models_wint.rds",sep=""))
        saveRDS(mod_wint_summary,
                paste("gen",YEAR,"_analysis",yr,"_",i,"empptecon_models_wint_summary.rds",sep=""))
        
        send_object(paste("gen",YEAR,"_analysis",yr,"_",i,"empptecon_models_wint.rds",sep=""),
                    "demographics_project_models",
                    paste("gen",YEAR,"_analysis",yr,"_",i,"empptecon_models_wint.rds",sep=""))
        send_object(paste("gen",YEAR,"_analysis",yr,"_",i,"empptecon_models_wint_summary.rds",sep=""),
                    "demographics_project_models",
                    paste("gen",YEAR,"_analysis",yr,"_",i,"empptecon_models_wint_summary.rds",sep=""))
         unlink(paste("gen",YEAR,"_analysis",yr,"_",i,"empptecon_models_wint.rds",sep=""))
         unlink(paste("gen",YEAR,"_analysis",yr,"_",i,"empptecon_models_wint_summary.rds",sep=""))
```
...
mod_woint_summary <- mod_woint %>% summary()
        ...
        saveRDS(mod_woint, paste("gen",YEAR,"_analysis",yr,"_",i,"empptecon_models_woint.rds",sep=""))
        saveRDS(mod_woint_summary,
                paste("gen",YEAR,"_analysis",yr,"_",i,"empptecon_models_woint_summary.rds",sep=""))
        
        send_object(paste("gen",YEAR,"_analysis",yr,"_",i,"empptecon_models_woint.rds",sep=""),
                    "demographics_project_models",
                    paste("gen",YEAR,"_analysis",yr,"_",i,"empptecon_models_woint.rds",sep=""))
        send_object(paste("gen",YEAR,"_analysis",yr,"_",i,"empptecon_models_woint_summary.rds",sep=""),
                    "demographics_project_models",
                    paste("gen",YEAR,"_analysis",yr,"_",i,"empptecon_models_woint_summary.rds",sep=""))
         unlink(paste("gen",YEAR,"_analysis",yr,"_",i,"empptecon_models_woint.rds",sep=""))
         unlink(paste("gen",YEAR,"_analysis",yr,"_",i,"empptecon_models_woint_summary.rds",sep=""))
```
