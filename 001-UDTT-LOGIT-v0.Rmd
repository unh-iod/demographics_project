...
#       ){
#           mod_df <- df1 %>%
#             mutate(y = ifelse(unempdtt == "Due to termination",1,0)) %>%
...
#           mod_df <- mod_df %>% select(-age25up)
#         }
#         mod_df$prtage <- mod_df$prtage %>% scale()
...
#         
#         cloud_prep()
#         saveRDS(mod_logit[[i]], paste("gen",YEAR,"_analysis",yr,"_",i,"udtt_models.rds",sep=""))
#         saveRDS(mod_summary, paste("gen",YEAR,"_analysis",yr,"_",i,"udtt_models_summary.rds",sep=""))
#         
#         send_object(paste("gen",YEAR,"_analysis",yr,"_",i,"udtt_models.rds",sep=""),
#                     "demographics_project_models",
#                     paste("gen",YEAR,"_analysis",yr,"_",i,"udtt_models.rds",sep=""))
#         send_object(paste("gen",YEAR,"_analysis",yr,"_",i,"udtt_models_summary.rds",sep=""),
#                     "demographics_project_models",
#                     paste("gen",YEAR,"_analysis",yr,"_",i,"udtt_models_summary.rds",sep=""))
#       }
#       
#       mod_logit[[i]] <- NA   
#      }
...
saveRDS(mod_anova_dis_chi,paste("gen",YEAR,"_analysis",yr,"_",i,"udtt_models_anova_chi_dis.rds",sep=""))
saveRDS(mod_anova_int_chi,paste("gen",YEAR,"_analysis",yr,"_",i,"udtt_models_anova_chi_int.rds",sep=""))
send_object( paste("gen",YEAR,"_analysis",yr,"_",i,"udtt_models_anova_chi_dis.rds",sep=""),"demographics_project_models",paste("gen",YEAR,"_analysis",yr,"_",i,"udtt_models_anova_chi_dis.rds",sep=""))
send_object( paste("gen",YEAR,"_analysis",yr,"_",i,"udtt_models_anova_chi_int.rds",sep=""),"demographics_project_models",paste("gen",YEAR,"_analysis",yr,"_",i,"udtt_models_anova_chi_int.rds",sep=""))

unlink(paste("gen",YEAR,"_analysis",yr,"_",i,"udtt_models_anova_chi_dis.rds",sep=""))
unlink(paste("gen",YEAR,"_analysis",yr,"_",i,"udtt_models_anova_chi_int.rds",sep=""))
```
...
saveRDS(mod_anova_dis,paste("gen",YEAR,"_analysis",yr,"_",i,"udtt_models_anova_dis.rds",sep=""))
saveRDS(mod_anova_int,paste("gen",YEAR,"_analysis",yr,"_",i,"udtt_models_anova_int.rds",sep=""))
send_object( paste("gen",YEAR,"_analysis",yr,"_",i,"udtt_models_anova_dis.rds",sep=""),"demographics_project_models",paste("gen",YEAR,"_analysis",yr,"_",i,"udtt_models_anova_dis.rds",sep=""))
send_object( paste("gen",YEAR,"_analysis",yr,"_",i,"udtt_models_anova_int.rds",sep=""),"demographics_project_models",paste("gen",YEAR,"_analysis",yr,"_",i,"udtt_models_anova_int.rds",sep=""))

unlink(paste("gen",YEAR,"_analysis",yr,"_",i,"udtt_models_anova_dis.rds",sep=""))
unlink(paste("gen",YEAR,"_analysis",yr,"_",i,"udtt_models_anova_int.rds",sep=""))
```
...
mod_wodis_summary <- mod_wodis %>% summary()
        ...
        saveRDS(mod_wodis, paste("gen",YEAR,"_analysis",yr,"_",i,"udtt_models_wodis.rds",sep=""))
        saveRDS(mod_wodis_summary,
                paste("gen",YEAR,"_analysis",yr,"_",i,"udtt_models_wodis_summary.rds",sep=""))
        
        send_object(paste("gen",YEAR,"_analysis",yr,"_",i,"udtt_models_wodis.rds",sep=""),
                    "demographics_project_models",
                    paste("gen",YEAR,"_analysis",yr,"_",i,"udtt_models_wodis.rds",sep=""))
        send_object(paste("gen",YEAR,"_analysis",yr,"_",i,"udtt_models_wodis_summary.rds",sep=""),
                    "demographics_project_models",
                    paste("gen",YEAR,"_analysis",yr,"_",i,"udtt_models_wodis_summary.rds",sep=""))
         unlink(paste("gen",YEAR,"_analysis",yr,"_",i,"udtt_models_wodis.rds",sep=""))
         unlink(paste("gen",YEAR,"_analysis",yr,"_",i,"udtt_models_wodis_summary.rds",sep=""))
```
...
mod_wint_summary <- mod_wint %>% summary()
        ...
        saveRDS(mod_wint, paste("gen",YEAR,"_analysis",yr,"_",i,"udtt_models_wint.rds",sep=""))
        saveRDS(mod_wint_summary,
                paste("gen",YEAR,"_analysis",yr,"_",i,"udtt_models_wint_summary.rds",sep=""))
        
        send_object(paste("gen",YEAR,"_analysis",yr,"_",i,"udtt_models_wint.rds",sep=""),
                    "demographics_project_models",
                    paste("gen",YEAR,"_analysis",yr,"_",i,"udtt_models_wint.rds",sep=""))
        send_object(paste("gen",YEAR,"_analysis",yr,"_",i,"udtt_models_wint_summary.rds",sep=""),
                    "demographics_project_models",
                    paste("gen",YEAR,"_analysis",yr,"_",i,"udtt_models_wint_summary.rds",sep=""))
         unlink(paste("gen",YEAR,"_analysis",yr,"_",i,"udtt_models_wint.rds",sep=""))
         unlink(paste("gen",YEAR,"_analysis",yr,"_",i,"udtt_models_wint_summary.rds",sep=""))
```
...
mod_woint_summary <- mod_woint %>% summary()
        ...
        saveRDS(mod_woint, paste("gen",YEAR,"_analysis",yr,"_",i,"udtt_models_woint.rds",sep=""))
        saveRDS(mod_woint_summary,
                paste("gen",YEAR,"_analysis",yr,"_",i,"udtt_models_woint_summary.rds",sep=""))
        
        send_object(paste("gen",YEAR,"_analysis",yr,"_",i,"udtt_models_woint.rds",sep=""),
                    "demographics_project_models",
                    paste("gen",YEAR,"_analysis",yr,"_",i,"udtt_models_woint.rds",sep=""))
        send_object(paste("gen",YEAR,"_analysis",yr,"_",i,"udtt_models_woint_summary.rds",sep=""),
                    "demographics_project_models",
                    paste("gen",YEAR,"_analysis",yr,"_",i,"udtt_models_woint_summary.rds",sep=""))
         unlink(paste("gen",YEAR,"_analysis",yr,"_",i,"udtt_models_woint.rds",sep=""))
         unlink(paste("gen",YEAR,"_analysis",yr,"_",i,"udtt_models_woint_summary.rds",sep=""))
```
